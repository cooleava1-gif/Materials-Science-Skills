...
This MCP is the upstream search and metadata-verification layer for `civil-materials-citation`, `civil-materials-reader`, and the broader civil-materials skill bundle.

## Installed Server

- Server name: `civil-materials-academic-search`
- Entry point: `$CODEX_HOME/skills/civil-materials-citation/mcp/academic_search/server.py`
...
- `material_domain`: `asphalt`, `cement-concrete`, or `civil-materials`
- `evidence_layer`
