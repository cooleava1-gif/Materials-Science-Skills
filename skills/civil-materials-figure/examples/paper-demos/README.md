...
`civil_materials_plot_lib.py` helper library.
...
```powershell
# Run a single demo
python skills/civil-materials-figure/examples/paper-demos/kong-2024-cbm-bonding/plot_bonding_strength.py --output-dir ./my-figures

# Run all demos in a paper
python skills/civil-materials-figure/examples/paper-demos/kong-2024-cbm-bonding/plot_bonding_strength.py --output-dir ./figures
python skills/civil-materials-figure/examples/paper-demos/kong-2024-cbm-bonding/plot_shear_vs_temperature.py --output-dir ./figures
```
...
2. Add a `plot_*.py` script using `civil_materials_plot_lib.py`
