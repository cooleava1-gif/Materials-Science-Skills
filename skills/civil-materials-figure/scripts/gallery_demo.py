#!/usr/bin/env python3
"""Generate SVG examples for the civil-materials figure gallery."""
...
def svg_shell(title: str, body: str, preset: dict[str, str], width: int = 960, height: int = 620) -> str:
    return "\n".join(
        [
            ...
            f'<text x="{width/2}" y="34" text-anchor="middle" font-family="{preset["font"]}" font-size="18" font-weight="700">Civil Materials Figure Gallery</text>',
