#!/usr/bin/env python3
"""Create a civil-materials paper reading Markdown scaffold."""
...
def main() -> int:
    ...
    parser.add_argument("--title", default="Untitled civil materials paper")
    parser.add_argument("--journal-year", default="")
    parser.add_argument("--material-family", default="civil materials")
