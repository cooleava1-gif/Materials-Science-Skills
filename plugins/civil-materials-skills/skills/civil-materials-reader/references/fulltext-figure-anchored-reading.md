...
Use this reference when turning a PDF, publisher HTML, pasted full text, or extracted text into a source-grounded `paper.md` for WER-EA and civil-materials review work.
