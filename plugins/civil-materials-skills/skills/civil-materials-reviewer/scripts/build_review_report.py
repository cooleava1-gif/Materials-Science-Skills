#!/usr/bin/env python3
"""Build a structured two-reviewer civil-materials review report."""
...
def build_report(title: str, journal_family: str) -> str:
    ...
    return f"""# Simulated Civil Materials Peer Review
...
1. Severity: Major. The novelty statement needs a sharper comparison with recent civil-materials literature and existing tack coat or composite systems.
