#!/usr/bin/env python3
"""Generate richer SVG assets for the civil-materials figure gallery."""
...
def svg_asset(title: str, subtitle: str, boundary: str, index: int) -> str:
    ...
    return "\n".join(
        [
            ...
            f'<text x="{width/2}" y="42" text-anchor="middle" font-family="DejaVu Sans" font-size="18" font-weight="700" fill="{PALETTE["muted"]}">Civil Materials Rich Gallery</text>',
