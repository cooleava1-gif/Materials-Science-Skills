#!/usr/bin/env python3
"""Generate materials-schematic drafts with OpenRouter's Images API.

Adapted from nature-skills' generate_openrouter_schematic.py (Apache-2.0),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate materials-schematic drafts with OpenRouter's Images API."
    )
