...
Use `materials-paper2ppt` when the user request matches this skill's production surface and the needed inputs are available or can be explicitly marked as missing.
...
```text
Turn a reader package into a journal-club slide outline.
```
