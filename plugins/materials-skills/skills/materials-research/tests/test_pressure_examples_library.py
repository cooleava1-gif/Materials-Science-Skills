...
class AllModulePressureSuiteTest(unittest.TestCase):
    ...
    def test_pressure_asset_audit_script_passes_current_contract(self):
        ...
        self.assertFalse(report["missing_modules"])
        self.assertFalse(report["missing_themes"])

    def test_router_exposes_pressure_suite_without_legacy_example_library(self):
        ...
        self.assertFalse((SKILL_ROOT / "examples" / "library").exists())
